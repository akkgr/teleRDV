    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
        {
            ...
            if (Properties.Settings.Default.InitializeApp)
            {
                ...
                if (admin == null)
                {
                    var rs = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(context.Get<ApplicationIdentityContext>().Roles));
                    rs.Create(new IdentityRole { Name = "Administrator" });
                    rs.Create(new IdentityRole { Name = "Subscriber" });
                    rs.Create(new IdentityRole { Name = "Agent" });
                    var user = new ApplicationUser { UserName = "admin", Email="admin@localhost.local" };                    
                    var u = manager.Create(user, "cinnamon");
